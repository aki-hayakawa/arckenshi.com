      ...
      <div class="page-wrapper">
        ...
        <div class="row page-titles">
          <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Ticket Detail</h3>
            ...
            <div class="col-lg-8">
              <div class="card">
                <div class="card-body">
                  ...
                  the one you have. Please advise if you provide this service
                  and i will send through my requirements. Regards.
                </div>
              </div>
              <div class="card">
                <div class="card-body">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="post">
                    ...
                    <button
                      type="button"
                      class="mt-3 btn waves-effect waves-light btn-info"
                    >
                      Reply & close
                    </button>
                  </form>
              ...
              <div class="card">
                <div class="card-body text-center">
                  ...
                  <div class="profile-pic mb-3 mt-3">
                    ...
                    <a href="mailto:danielkristeen@gmail.com"
                      >danielkristeen@gmail.com</a
                    >
                  </div>
                    ...
                    <div class="col-6">
                      <a
                        ...
                        class="
                          ...
                          font-weight-medium
                        "
                        ><i class="mdi mdi-developer-board fs-6 me-1"></i
                        >Portfolio</a
                      >
                    </div>
                  </div>
